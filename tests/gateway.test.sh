...
require_pattern '@supply path /supply /api/supply /api/v1/supply /api/v2/supply /api/v2/totalsupply /api/v2/total-supply /api/v2/circulating-supply'
require_pattern '@mainnetDisabled path /mainnet\*'
require_pattern 'handle @mainnetDisabled'
require_pattern 'respond 404'
